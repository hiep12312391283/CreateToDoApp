      ...
      children: [
        Row(
          ...
          children: [
            ...
            GestureDetector(
                onTap: () {
                  for (int index = 0; index < listCompleted.length; index++) {
                    final updateItem = listCompleted[index];
                    final newAllItem = updateItem.copyWith(isChecked: false);
                    listIncomplete.add(newAllItem);
                  }
                  setState(() {
                    listCompleted.clear();
                  });
